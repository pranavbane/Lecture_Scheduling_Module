...
import { z } from 'zod';
import { Mail, Lock, User, Eye, EyeOff, GraduationCap, UserPlus, ArrowRight } from 'lucide-react';
        ...
        <div className="relative bg-white/10 backdrop-blur-2xl backdrop-filter rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
          <div className="text-center mb-8 relative">
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              ...
              <span className="text-white/60 text-sm">INSTRUCTOR REGISTRATION</span>
              <div className="h-px w-12 bg-white/20"></div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div className="relative group">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/40 group-focus-within:text-white/70 transition-colors" />
                <input
                  {...register('name')}
                  type="text"
            ...
            <p className="text-center text-sm text-white/60">
              ...
              <Link
                to="/login"
                className="text-blue-300 font-medium hover:text-blue-200 transition-colors duration-300 hover:underline"
              >
                Sign In
              </Link>
            </p>
