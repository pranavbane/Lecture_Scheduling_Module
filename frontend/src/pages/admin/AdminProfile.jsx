...
const Profile = () => {
  ...
  const statCards = user?.role === 'instructor' ? [
    {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-4">
      ...
      {/* Statistics Section - Only for Instructors */}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-2.5 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none transition-all"
