...
const CourseManagement = () => {
  ...
  const fetchCourses = async () => {
    setLoading(true);
    try {
      const response = await getCourses({ page: pagination.page, search });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none resize-none"
